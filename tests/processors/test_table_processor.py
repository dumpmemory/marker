...
def test_avoid_double_ocr(pdf_document, recognition_model, table_rec_model):
...
def test_overlap_blocks(pdf_document, recognition_model, table_rec_model):
